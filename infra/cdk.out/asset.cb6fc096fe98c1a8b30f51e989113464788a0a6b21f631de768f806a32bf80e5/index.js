...
var getBookedIntervals = async (psychiatristId, date, includePending = true) => {
...
// ../api/node_modules/luxon/src/errors.js
...
// ../api/node_modules/luxon/src/impl/formats.js
var n = "numeric";
var s = "short";
var l = "long";
var DATE_SHORT = {
...
// ../api/node_modules/luxon/src/zone.js
var Zone = class {
  /**
   * The type of zone
   * @abstract
...
// ../api/node_modules/luxon/src/zones/systemZone.js
var singleton = null;
...
// ../api/node_modules/luxon/src/zones/IANAZone.js
...
// ../api/node_modules/luxon/src/impl/locale.js
var intlLFCache = {};
...
// ../api/node_modules/luxon/src/zones/fixedOffsetZone.js
var singleton2 = null;
...
// ../api/node_modules/luxon/src/zones/invalidZone.js
...
// ../api/node_modules/luxon/src/impl/zoneUtil.js
...
// ../api/node_modules/luxon/src/impl/digits.js
...
// ../api/node_modules/luxon/src/settings.js
var now = () => Date.now();
...
// ../api/node_modules/luxon/src/impl/invalid.js
var Invalid = class {
...
// ../api/node_modules/luxon/src/impl/conversions.js
...
// ../api/node_modules/luxon/src/impl/util.js
...
// ../api/node_modules/luxon/src/impl/english.js
var monthsLong = [
  "January",
  "February",
  "March",
...
// ../api/node_modules/luxon/src/impl/formatter.js
...
// ../api/node_modules/luxon/src/impl/regexParser.js
...
// ../api/node_modules/luxon/src/duration.js
...
// ../api/node_modules/luxon/src/interval.js
...
// ../api/node_modules/luxon/src/info.js
var Info = class {
  /**
...
// ../api/node_modules/luxon/src/impl/diff.js
...
// ../api/node_modules/luxon/src/impl/tokenParser.js
...
// ../api/node_modules/luxon/src/datetime.js
...
// ../api/timeUtils.ts
var toUtcIso = (date, timeHHmm, zone) => {
...
var AppointmentSchema = new import_schemy_ts.Schemy({
  psychiatristId: {
    type: String,
    required: true,
    min: 1
  ...
  date: {
    ...
    required: true,
    regex: /^\d{4}-\d{2}-\d{2}$/
    // YYYY-MM-DD (interpreted in psychiatrist's timezone)
  },
  startTime: {
    type: String,
    required: true,
    regex: /^([0-1]\d|2[0-3]):([0-5]\d)$/
    // HH:mm (interpreted in psychiatrist's timezone)
  }
});
var handler = async (event) => {
  try {
    ...
    if (!AppointmentSchema.validate(body)) {
      return {
        statusCode: 400,
        body: JSON.stringify({
          error: "Invalid input",
          details: AppointmentSchema.validationErrors
        })
      };
    }
    const psychiatristId = body.psychiatristId;
    const date = body.date;
    const startTime = body.startTime;
    const { profile, scheduleBlocks } = await getPsychiatristSchedule(psychiatristId, date);
    if (!profile?.timezone) {
      return {
        statusCode: 400,
        body: JSON.stringify({ error: "Psychiatrist profile missing timezone" })
      };
    }
    if (scheduleBlocks.length === 0) {
      return {
        statusCode: 400,
        body: JSON.stringify({ error: "Psychiatrist not available on this date" })
      };
    }
    const bookedIntervals = await getBookedIntervals(psychiatristId, date, true);
    const requestedStartMinutes = hhmmToMinutes(startTime);
    const requestedEndMinutes = requestedStartMinutes + APPOINTMENT_MINUTES;
    let fitsSchedule = false;
    for (const block of scheduleBlocks) {
      const isInsideBlock = requestedStartMinutes >= block.start && requestedEndMinutes <= block.end;
      if (isInsideBlock) {
        fitsSchedule = true;
      }
    }
    if (!fitsSchedule) {
      return {
        statusCode: 400,
        body: JSON.stringify({ error: "Requested time is outside psychiatrist working hours" })
      };
    }
    const hasOverlap = bookedIntervals.some((bookedInterval) => {
      const endsBefore = requestedEndMinutes <= bookedInterval.start;
      const startsAfter = requestedStartMinutes >= bookedInterval.end;
      return !(endsBefore || startsAfter);
    });
    if (hasOverlap) {
      return {
        statusCode: 400,
        body: JSON.stringify({ error: "Requested time overlaps with an existing appointment" })
      };
    }
    const endTimeHours = String(Math.floor(requestedEndMinutes / 60)).padStart(2, "0");
    const endTimeMinutes = String(requestedEndMinutes % 60).padStart(2, "0");
    const endTime = `${endTimeHours}:${endTimeMinutes}`;
    const startUtc = toUtcIso(date, startTime, profile.timezone);
    const endUtc = toUtcIso(date, endTime, profile.timezone);
        ...
        Item: (0, import_util_dynamodb2.marshall)(
          {
            ...
            SK: `PSYCHIATRIST#${psychiatristId}`,
            // Index to fetch appointments for a given date and psychiatrist
            GSI2PK: `DATE#${date}`,
            GSI2SK: `PSYCHIATRIST#${psychiatristId}#APPOINTMENT#${appointmentId}`,
            status: "PENDING",
            // Minutes since midnight for easier overlap calculations
